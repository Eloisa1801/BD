...
===================================================================================
                           ANTES DE EXECUTAR:
===================================================================================
1) Descompacte o arquivo CSVs.zip em uma pasta (diretório)
2) Crie um BD no servidor Postgresql com nome Controle_Voo;
3) Altere neste script todas as ocorrências de "D:\mini_PostgreSQL/" 
...
COPY fakenames FROM
  'D:\mini_PostgreSQL/fakenames.csv' csv header delimiter ';' quote '"';
...
COPY AeroportosBrasileiros FROM
  'D:\mini_PostgreSQL/AeroportosBrasileiros.csv' csv header delimiter ';' quote '"';
...
COPY  DataNasc FROM
  'D:\mini_PostgreSQL/DataNasc.csv' csv header delimiter ';' quote '"';
...
COPY Funcionario FROM
  'D:\mini_PostgreSQL/Funcionario.csv' csv header delimiter ';' quote '"';


COPY Aeromoca FROM
  'D:\mini_PostgreSQL/Aeromoca.csv' csv header delimiter ';' quote '"';


COPY Piloto FROM
  'D:\mini_PostgreSQL/Piloto.csv' csv header delimiter ';' quote '"';
